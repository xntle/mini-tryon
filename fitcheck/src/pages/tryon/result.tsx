...
// Configure FAL only if a credential is present, otherwise skip
try {
  // Vite-style env access; falls back to undefined when not provided
  const falKey = (import.meta as any)?.env?.VITE_FAL_KEY as string | undefined;
  if (falKey) {
    fal.config({ credentials: falKey });
  }
} catch (_) {
  // non-Vite environments or missing import.meta – ignore
}
